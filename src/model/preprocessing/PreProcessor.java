...
import static model.preprocessing.MathUtils.*;

/**
 * Transforms a time series model.data representation into
...
public abstract class PreProcessor {
    ...
    /**
     * Executes the discretization process upon a TimeSeries model.data object. This involves checking
     * first whether the model.data is in a z-normalized form and performing the normalization process if
     * required. The normalized model.data is then transformed into a reduced format before being converting
     * into a String word ready for the model.classification process.
     * @param rawData the TimeSeries object upon which the discretization process will take place.
     * @return a String representation of the time series model.data of this TimeSeries object.
     */
     ...
     * This is to ensure that the effect of any offset and scaling amongst the model.data samples are
     * nullified.
     * @param input model.data obtained from this TimeSeries object.
     * @return the input model.data in z-normalized form.
     */
