...
public class MathUtils {
    ...
    /**
     * Calculates the mean of the input model.data by summing the values and then
    ...
    /**
     * Calculates the standard deviation of the input model.data. The result expresses
     * how much the values of the input model.data differ from the mean value of the model.data
     * as a whole.
     * @param inputData the list of double values
    ...
    /**
     * Tests whether the input model.data has already been z-normalized. A model.data sample is said to
     * be z-normalised if its mean is 0 and standard deviation is 1.
     * @param inputData the list of double values to be tested.
     * @return true if the model.data is z-normalized, false otherwise.
     */
