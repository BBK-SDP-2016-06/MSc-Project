 ...
 * user, establishing a set of 'breakpoints'. From these, a classificationApp.model.data sample can be
 * converted to a word ready for classificationApp.model.classification.
